...
def save_community(sender, instance, **kwargs):
    action.send(instance.community_builder, verb="Community Has Been Created", target=instance)


def delete_community(sender, instance, **kwargs):
    action.send(instance.community_builder, verb="Community Has Been Deleted", target=instance)


post_save.connect(save_community, sender=Community)
post_delete.connect(delete_community, sender=Community)
